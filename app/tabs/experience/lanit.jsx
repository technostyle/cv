  ...
  <Accordion>
    <Card>
      ...
      <Accordion.Collapse eventKey="0">
        <Card.Body>
            Working as outstaff in big Russian corporation. Worked with internal ui-kit visual components library.
            Implemented features for web client service.
            Was a core developer of a team concerned of separating legacy interanl application into microfrontends. 
        </Card.Body>
      </Accordion.Collapse>
    </Card>
    <Card>
