...
export const PersonalSkills = () => (
  <Container>
    <ListGroup>
      <SkillItem trait="Team player" estimation={50} />
      <SkillItem trait="Able to work independently" estimation={70} />
      <SkillItem trait="Self driven" estimation={85} />
      <SkillItem trait="Taking responsibility" estimation={70} />
      <SkillItem trait="Open for learning" estimation={70} />
      <SkillItem trait="Able to estimate time" estimation={80} />
    </ListGroup>
  </Container>
);
